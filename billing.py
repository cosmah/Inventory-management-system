...
#====================================customer frame==================================
        ...
        txt_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,bg="lightyellow",).place(x=390,y=35,width=120,height=22)

        self.lbl_inStock=Label(Add_CartWidgetsFrame,text="In Stock",font=("times new roman",15),bg="white")
        self.lbl_inStock.place(x=5,y=70)

        btn_clear_cart=Button(Add_CartWidgetsFrame,text="Clear",command=self.clear_cart,font=("goudy old style",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
...
#=================All Functions==============================
    ...
    def bill_updates(self):
        ...
        self.lbl_amnt.config(text=f'Amount(Shs.)\n[{str(self.bill_amnt)}]')
        self.lbl_net_pay.config(text=f'Net Pay(Shs.)\n[{str(self.net_pay)}]')
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            messagebox.showerror('Error',"Please Add Commodities to the Cart",parent=self.root)
        else:
            #====Bill Top====
            self.bill_top()
            #====Bill Middle====
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\t\tCosmc Inc
\tPhone No.+256708153467, Kampala-Uganda
{str("="*47)}
...
{str("="*47)}
    ...
    def bill_bottom(self):
        bill_bottom_temp=f'''
{str("="*47)}        
 Bill Amount\t\t\t\tShs.{self.bill_amnt}
 Discount\t\t\t\tShs.{self.discount}
 Net Pay\t\t\t\tShs.{self.net_pay}
{str("="*47)}\n
        '''
