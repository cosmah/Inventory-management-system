...
class productClass:
    ...
    def __init__(self,root):
        ...
        #========column2======
        cmd_cat=ttk.Combobox(product_Frame,textvariable=self.var_cat,values=self.cat_list,state='readonly',justify=CENTER,font=("time new roman",15))
        cmd_cat.place(x=150,y=60,width=200)
        cmd_cat.current(0)

        cmd_sup=ttk.Combobox(product_Frame,textvariable=self.var_sup,values=self.sup_list,state='readonly',justify=CENTER,font=("time new roman",15))
        ...
        cmd_status=ttk.Combobox(product_Frame,textvariable=self.var_status,values=("Active","Inactive"),state='readonly',justify=CENTER,font=("time new roman",15))
        cmd_status.place(x=150,y=310,width=200)
        cmd_status.current(0)


        #===buttons=====
        btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white").place(x=10,y=400,width=100,height=40)
        btn_update=Button(product_Frame,text="Update",command=self.Update,font=("goudy old style",15),bg="#4caf50",fg="white").place(x=120,y=400,width=100,height=40)
        btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white").place(x=230,y=400,width=100,height=40)
        btn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white").place(x=340,y=400,width=100,height=40)
        ...
        #========options=======
        cmd_search=ttk.Combobox(searchframe,textvariable=self.var_searchby,values=("Select","Category","Supplier","Name"),state='readonly',justify=CENTER,font=("time new roman",15))
        ...
        self.productTable.column("Category",width=200)
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                ...
                messagebox.showerror("Error","Searchinput should be required",parent=self.root)
