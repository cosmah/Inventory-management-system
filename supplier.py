...
class supplierClass:
    ...
    def __init__(self,root):
        ...
        #========options=======
        lbl_search=Label(self.root,text="Invoice No.",bg="white",font=("time new roman",12))
        ...
        btn_search=Button(self.root,text="search",command=self.search,font=("goudy old style",15),bg="#4caf50",fg="white").place(x=980,y=79,width=100,height=28)
        ...
        #===buttons=====
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white").place(x=150,y=370,width=110,height=35)
        btn_update=Button(self.root,text="Update",command=self.Update,font=("goudy old style",15),bg="#4caf50",fg="white").place(x=270,y=370,width=110,height=35)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white").place(x=390,y=370,width=110,height=35)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white").place(x=510,y=370,width=110,height=35)
        ...
        self.SupplierTable.heading("invoice",text="Ivoice No.")
